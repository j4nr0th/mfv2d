...
from interplib.lagrange import interp1d_derivative_samples as interp1d_derivative_samples
from interplib.lagrange import interp1d_2derivative_samples as interp1d_2derivative_samples

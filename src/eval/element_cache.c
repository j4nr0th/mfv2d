...
static PyObject *element_mass_matrix_cache_get_basis(element_mass_matrix_cache_t *self, void *Py_UNUSED(closure))
{
    Py_INCREF(self->basis);
    return (PyObject *)self->basis;
}
...
static PyGetSetDef element_mass_matrix_cache_getsets[] = {
    ...
    {
        .name = "basis",
        .get = (getter)element_mass_matrix_cache_get_basis,

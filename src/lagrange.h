...
/**
* @brief Compute values of Lagrange polynomials with given nodes at specified locations.
* The interpolation can be computed for any function on the same mesh by taking the inner
* product of the weight matrix with the function values.
*
...
/**
* @brief Compute first derivative of Lagrange polynomials with given nodes at specified locations.
* The interpolation can be computed for any function on the same mesh by taking the inner
* product of the weight matrix with the function values.
*
* @param n_in Number of points where the interpolation will be needed.
...
/**
* @brief Compute second derivative of Lagrange polynomials with given nodes at specified locations.
* The interpolation can be computed for any function on the same mesh by taking the inner
* product of the weight matrix with the function values.
*
* @param n_in Number of points where the interpolation will be needed.

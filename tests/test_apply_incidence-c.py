...
def test_left_e10(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 0, False, False)
...
def test_left_e21(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 1, False, False)
    assert pytest.approx(out_1) == out_2
...
def test_left_e10_t(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 0, True, False)
    assert pytest.approx(out_1) == out_2
...
def test_left_e21_t(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 1, True, False)
    assert pytest.approx(out_1) == out_2
...
def test_left_e10_r(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 0, False, True)
    assert pytest.approx(out_1) == out_2
...
def test_left_e21_r(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 1, False, True)
    assert pytest.approx(out_1) == out_2
...
def test_left_e10_rt(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 0, True, True)
    assert pytest.approx(out_1) == out_2
...
def test_left_e21_rt(order: int):
    ...
    out_2 = check_incidence(in_mat, order, 1, True, True)
    assert pytest.approx(out_1) == out_2
